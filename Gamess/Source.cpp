...
void set_pos_ball(int counter, Sprite clrs[], RenderWindow& window , Event& event)      //RANEEM
{
...
void Filling_cannon_balls(Texture& redd, Texture& cyann, Texture& yelow, Texture& orangee)    //RANEEM
{
...
int main()
{
	...
	Texture redd, yelow, cyann, orangee, backk, cannon_sheet, cannon_base, background, bubble, start, animal, menu, monkey, monkey2, senjap, poma, bubb, buuu,
		highh, hscore, howplay, backimage, kass, level, animation, ground,
		pointer, bname, bhow, congrats, winscore;
	redd.loadFromFile("red.png");
	yelow.loadFromFile("yellow.png");
	cyann.loadFromFile("cyan.png");
	...
	Sprite backs, base, cannon_sprite, upper_ball_colors[10][25], back, bub, st, ani, men, mon, mon2, sen, pom, bu[3], buu, b, hig, kas, animat, grou, point,
	...
	Filling_cannon_balls(redd, cyann, yelow, orangee);      //FUNCTION FILLING CANNON
	...
	Text sstart, play, exit, totalscores, hs, backh, leve, score, text, next, hello,
		name, how, howback, cong, scoree, winhigh, scorepage, winssssscore, score_max,
		aa1, aa2, aa3, aa4, aa5, score_val, lose, htp, goodluck;
	...
	totalscores.setPosition(335, 310);
	totalscores.setCharacterSize(60);
	...
	while (window.isOpen())
	{
		...
		while (window.pollEvent(event))
		{
			...
			//move function of the ball                    //RANEEM
		...
		/*if (move_ball)
		{
			set_pos_ball(counter, ball.shooting_ball, window,event);
		}*/
